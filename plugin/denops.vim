...
if !get(g:, 'denops_disable_version_check') && !has('nvim-0.8.0') && !has('patch-8.2.3452')
  echohl WarningMsg
  echomsg '[denops] Denops requires Vim 8.2.3452 or Neovim 0.8.0. See ":h g:denops_disable_version_check" to disable this check.'
  echohl None
  finish
endif
