...
if !get(g:, 'denops_disable_version_check') && !has('nvim-0.9.5') && !has('patch-9.1.0399')
  echohl WarningMsg
  echomsg '[denops] Denops requires Vim 9.1.0399 or Neovim 0.9.5. See ":h g:denops_disable_version_check" to disable this check.'
  echohl None
  finish
endif
